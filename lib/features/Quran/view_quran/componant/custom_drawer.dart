        ...
        return Drawer(
          ...
          child: BlocBuilder<ThemeCubit, ThemeState>(
            builder: (context, state) {
              return Container(
                color:
                    isDark ? Colors.white : Colors.black87, // Background color
                child: ListView(
                    ...
                    Container(
                        ...
                        child: const Text('ألخصائص',
                            style: TextStyle(
                                ...
                                fontWeight: FontWeight.bold))),
                    const CustomListTile(
                        title: 'الترجمة', icon: Icons.translate),
                    const CustomListTile(
                        title: 'التفسير', icon: Icons.library_books),
                    const CustomListTile(title: 'المعاني', icon: Icons.notes),
                    const CustomListTile(
                        title: 'الصوتيات', icon: Icons.volume_up),
