...
//             tabs: [
//               Tab(text: S.of(context).surah), // First Tab
//               Tab(text: S.of(context).Number), // Second Tab
//             ],
//           ),
//         ),
//         body: BlocProvider(
//           create: (context) => SurahCubit()..loadNameOfSurah(),
...
//               context,
//               MaterialPageRoute(
//                 builder: (context) => SurahDetailScreen(ayah: surah),
//               ),
//             );
//           },
//         );
...
import 'package:flutter/material.dart';
import 'package:flutter_app/features/Quran/list_quran/componant/arabic_surah_number.dart';
